      ...
      <main className="flex-1 lg:ml-64 flex flex-col min-h-screen relative">
        ...
        <div className="p-6 max-w-6xl mx-auto w-full space-y-6">
          <div className="flex justify-between items-end mb-6">
            <div>
              <h1 className="text-3xl font-bold text-white tracking-tight">Active Disruptions</h1>
              <p className="text-gray-400 mt-1">Real-time monitoring of supply chain anomalies.</p>
            </div>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-white/10 bg-white/5">
                  ...
                  <th className="p-4 text-xs font-semibold text-gray-400 uppercase tracking-wider">Component</th>
                  <th className="p-4 text-xs font-semibold text-gray-400 uppercase tracking-wider">Event Type</th>
                  <th className="p-4 text-xs font-semibold text-gray-400 uppercase tracking-wider">Severity</th>
                  <th className="p-4 text-xs font-semibold text-gray-400 uppercase tracking-wider">Detected</th>
              ...
              <tbody className="divide-y divide-white/5">
                {disruptions.map((d, i) => (
                  <tr key={i} className="hover:bg-white/5 transition-colors">
                    ...
                    <td className="p-4 text-sm font-bold text-white">{d.part}</td>
                    ...
                    <td className="p-4 text-sm text-gray-400 flex items-center gap-1"><Clock className="w-3 h-3" /> {d.time}</td>
