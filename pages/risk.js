      ...
      <main className="flex-1 lg:ml-64 flex flex-col min-h-screen relative">
        ...
        <div className="p-6 max-w-6xl mx-auto w-full space-y-6">
          <div className="flex justify-between items-end mb-6">
            <div>
              <h1 className="text-3xl font-bold text-white tracking-tight">Predictive Risk Analysis</h1>
              <p className="text-gray-400 mt-1">AI-driven geopolitical, climate, and logistical risk evaluation.</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            <div className="glass-panel p-5 border-l-4 border-orange-500 relative overflow-hidden">
              ...
              <p className="text-xs text-gray-400 uppercase tracking-wider mb-1 relative z-10">Global Risk Index</p>
            ...
            <div className="glass-panel p-5 border-l-4 border-indigo-500">
              <p className="text-xs text-gray-400 uppercase tracking-wider mb-1">Monitored Nodes</p>
            ...
            <div className="glass-panel p-5 border-l-4 border-emerald-500">
              <p className="text-xs text-gray-400 uppercase tracking-wider mb-1">Mitigated Value</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="glass-panel p-6">
              <h3 className="text-lg font-bold text-white mb-4 flex items-center gap-2"><Globe className="w-5 h-5 text-blue-400" /> Geopolitical Risk Radar</h3>
              <div className="space-y-4">
                <div>
                  ...
                  <div className="w-full bg-gray-800 h-2 rounded-full"><div className="bg-red-500 h-2 rounded-full" style={{width: '85%'}}></div></div>
                </div>
                <div>
                  <div className="flex justify-between text-sm mb-1">
                  ...
                  <div className="w-full bg-gray-800 h-2 rounded-full"><div className="bg-orange-500 h-2 rounded-full" style={{width: '60%'}}></div></div>
                </div>
                <div>
                  <div className="flex justify-between text-sm mb-1">
                  ...
                  <div className="w-full bg-gray-800 h-2 rounded-full"><div className="bg-emerald-500 h-2 rounded-full" style={{width: '20%'}}></div></div>
                </div>
              </div>
            </div>

            <div className="glass-panel p-6">
              <h3 className="text-lg font-bold text-white mb-4 flex items-center gap-2"><Activity className="w-5 h-5 text-indigo-400" /> AI Threat Intelligence</h3>
              <ul className="space-y-3">
                <li className="p-3 bg-red-500/10 border border-red-500/20 rounded-lg">
                  ...
                  <p className="text-xs text-gray-400">Intelligence models detect a 92% probability of new MCU export restrictions within 72 hours.</p>
                </li>
                <li className="p-3 bg-orange-500/10 border border-orange-500/20 rounded-lg">
                  ...
                  <p className="text-xs text-gray-400">Global tracking indicates a 15% reduction in available NAND flash memory inventory across tier-1 suppliers.</p>
                </li>
                <li className="p-3 bg-white/5 border border-white/10 rounded-lg">
                  ...
                  <p className="text-xs text-gray-400">Distributor A has expanded warehousing capacity in Taiwan, decreasing average lead time by 2 days.</p>
                </li>
              </ul>
            </div>
          </div>
