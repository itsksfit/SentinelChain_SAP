      ...
      <main className="flex-1 lg:ml-64 flex flex-col min-h-screen relative">
        ...
        <div className="p-6 max-w-6xl mx-auto w-full space-y-6">
          <div className="flex justify-between items-end mb-6">
            <div>
              <h1 className="text-3xl font-bold text-white tracking-tight">Supply Network</h1>
              <p className="text-gray-400 mt-1">Global vendor mapping and supplier health tracking.</p>
            </div>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <div className="glass-panel p-6">
              <p className="text-sm text-gray-400 flex items-center gap-2 mb-2"><Database className="w-4 h-4" /> Active Suppliers</p>
              <p className="text-3xl font-bold text-white">1,402</p>
            </div>
            <div className="glass-panel p-6">
              <p className="text-sm text-gray-400 flex items-center gap-2 mb-2"><TrendingUp className="w-4 h-4" /> Network Health</p>
              <p className="text-3xl font-bold text-emerald-400">92%</p>
            </div>
            <div className="glass-panel p-6">
              <p className="text-sm text-gray-400 flex items-center gap-2 mb-2"><MapPin className="w-4 h-4" /> Geographies</p>
              <p className="text-3xl font-bold text-white">34 Countries</p>
            </div>
          </div>

          <div className="glass-panel p-6">
            <h3 className="text-lg font-bold text-white mb-4">Critical Tier-1 & Tier-2 Suppliers</h3>
                ...
                <tbody className="divide-y divide-white/5">
                  {suppliers.map((s, i) => (
                    <tr key={i} className="hover:bg-white/5">
                      <td className="py-4 font-bold text-white flex items-center gap-2"><ShieldCheck className="w-4 h-4 text-indigo-400" /> {s.name}</td>
